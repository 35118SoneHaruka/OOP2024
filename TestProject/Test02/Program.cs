...
namespace Test02 {
    ...
    class Program {
        ...
        private static void Exercise03(List<int> numbers) {
            var sort = numbers.Where(n => n % 2 == 1).OrderByDescending(n => n);
        ...
        private static void Exercise04(List<int> numbers) {
            var num = numbers.Where(n => 10 <= n && n <= 50);
        ...
        private static void Exercise06(List<Person> persons) {
            var average = persons.Where(n => n.Height >= 170).Average(n => n.Weight);
        ...
        private static void Exercise08(List<Person> persons) {
            var selected = persons.Where(p => p.Name.Contains("山"));
